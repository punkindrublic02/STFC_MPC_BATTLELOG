...
const Content = ({ ship, parsedData, raw_json }: TableProps) => {
...
export const Stats = ({ parsedData, input, data, raw_json }: StatsProps) => {
    ...
    <React.Fragment>
      <Grid container spacing={2}>
        ...
        {shipId === undefined ? null : (
          <Content ship={parsedData.shipById[shipId]} parsedData={parsedData} raw_json={raw_json} />
        )}
      </Grid>
    </React.Fragment>
  );
