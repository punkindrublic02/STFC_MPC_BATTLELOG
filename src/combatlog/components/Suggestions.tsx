...
const Content = ({ playerShip, targetShip, parsedData, raw_json, input, data }: ContentProps) => {
...
export const Suggestions = ({ parsedData, input, data, raw_json }: SuggestionsProps) => {
