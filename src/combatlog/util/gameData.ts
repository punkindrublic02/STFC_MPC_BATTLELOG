        ...
        for (let t = 0; t < ship.tiers.length; ++t) {
            ...
            for (let c = 0; c < tier.components.length; ++c) {
                ...
                if (component.id == id) {
                    return {
                        component,
                        displayName: `Mk${tier.tier} ${lookupComponentName(component.loca_id, data) || component.data.tag
                            }`,
                    };
                }
            }
...
interface BuffLookupResultOfficer {
    type: "officer";
    subtype: "officer_name" | "captain_ability" | "officer_ability" | "below_decks_ability" | "other";
