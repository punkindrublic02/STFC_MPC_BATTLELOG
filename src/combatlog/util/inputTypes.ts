...
export interface JournalsGetMessage {
  battle_log: RawCombatLog;
  journal: RawCombatLog;

  // Fields added by the community mod
...
export interface RawFleetInfo {
  ...
  is_debuffed: boolean;
  is_war_shield_activated: boolean;
  is_armada_supported: boolean;
  is_weapon_damage_activated: boolean;
  is_weapon_penetration_activated: boolean;
  is_weapon_shots_activated: boolean;
  is_critical_damage_activated: boolean;
  is_detected: boolean;
  is_system_wide_buffed: boolean;
  is_system_wide_supreme_buffed: boolean;
}
...
export interface RawFleetData {
  ...
  initial_cargo: {
    resources?: Dictionary<string, number>;
  };
  cargo_max: any;
  cargo_max_list: any[];
  initial_cargo_list: {
  ...
  num_drydocks: number;
  // Officers
  fleets_officers: Dictionary<string, (RawBridgeOfficer | null)[]>;
